...
<?if($arResult['ITEMS']):?>
	...
	<div class="catalog item-views table front" style="display:none;">
		<div class="top_wrapper_block nomargin_bottom">
			...
			<div class="flexslider unstyled row" data-plugin-options='{"animation": "slide", "directionNav": true, "itemMargin":30, "controlNav" :true, "animationLoop": true, "slideshow": true, "slideshowSpeed": 3000, "counts": [<?=$countmd?>, <?=$countsm?>, <?=$countxs?>, <?=$countxsm?>]}'>
